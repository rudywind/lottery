                            ...
                            <div class="col-12 col-lg-auto px-2 px-lg-0">
                                ...
                                <div class="banner-wrapper text-1 mt-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="banner-icon"><img class="img-icon" src="./../assets/wp-content/themes/lottery_argentina/assets/images/icon-1.png" alt="icon"></div>
                                        </div>
                                ...
                                <div class="banner-wrapper text-1 mt-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="banner-icon"><img class="img-icon" src="./../assets/wp-content/themes/lottery_argentina/assets/images/icon-2.png" alt="icon"></div>
                                        </div>
                                        <div class="col-auto"><div class="banner-separator"></div></div>
                                        <div class="col">
                                            <p class="banner-title font-weight-bold">
                                ...
                                <div class="banner-wrapper text-1 mt-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="banner-icon"><img class="img-icon" src="./../assets/wp-content/themes/lottery_argentina/assets/images/icon-3.png" alt="icon"></div>
                                        </div>
                                        <div class="col-auto"><div class="banner-separator"></div></div>
                                        <div class="col">
                                            <p class="banner-title font-weight-bold">
                                ...
                                <div class="banner-wrapper text-1 mt-3">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="banner-icon"><img class="img-icon" src="./../assets/wp-content/themes/lottery_argentina/assets/images/icon-4.png" alt="icon"></div>
                                        </div>
                                        <div class="col-auto"><div class="banner-separator"></div></div>
                                        <div class="col">
                                            <p class="banner-title font-weight-bold">
                                ...
                                <div class="winner-wrapper mt-4 mt-lg-0">
                                    <div class="card-title bg-gradient-2 px-4 py-2">
                                        ...
                                        <p class="text-white text-center mb-0">
                                            ...
                                            <small>&nbsp;|&nbsp;</small>
                                            <small>Date :15 January 2025</small>
                                        </p>
                                    </div>
                                    <div class="row no-gutters">
                                        <div class="col-12">
                                            ...
                                            <div class="pool-wrapper text-white mb-4"><div id="lastdraw-lottery-main-1" class="text-center prize-wrapper"><div class="prize-block d-inline-block winner ball-2">    <div class="prize-digit">        <span id="lastdraw-lottery-main-1-1" data-parent="lastdraw-lottery-main-1">0</span>    </div></div><div class="prize-block d-inline-block winner ball-3">    <div class="prize-digit">        <span id="lastdraw-lottery-main-1-2" data-parent="lastdraw-lottery-main-1">2</span>    </div></div><div class="prize-block d-inline-block winner ball-0">    <div class="prize-digit">        <span id="lastdraw-lottery-main-1-3" data-parent="lastdraw-lottery-main-1">3</span>    </div></div><div class="prize-block d-inline-block winner ball-9">    <div class="prize-digit">        <span id="lastdraw-lottery-main-1-4" data-parent="lastdraw-lottery-main-1">3</span>    </div></div></div></div>
                                        </div>
                                        <div class="col-6">
