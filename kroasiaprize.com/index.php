...
<html lang="en-US">
    <head>
        ...
        <title>Kroasia Prize - Official Lottery Website</title>
        <meta name="robots" content="max-image-preview:large">
        <link rel="stylesheet" id="wp-block-library-css" href="assets/style.min.css" type="text/css" media="all">
        <meta name="generator" content="WordPress 6.4.2">
        <link rel="canonical" href="https://kroasiaprize.com/">
        <link rel="shortlink" href="https://kroasiaprize.com/">
    ...
    <body class="home page-template page-template-page-home page-template-page-home-php page page-id-9 wp-custom-logo">
        <style>
            ...
            header::before {
                ...
                width: auto;
                height: auto;
                background-image: url(/web/20240721011049im_/https://kroasiaprize.com/images/header-bg.jpg);
                        ...
                        <nav class="navbar navbar-main navbar-dark navbar-expand px-0 py-0">
                            <div class="navbar-collapse text-center my-0">
                                <ul class="navbar-nav ml-auto mr-auto">
                                    <li id="menu-item-28"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-9 current_page_item active menu-item-28 nav-item active ">
                                    ...
                                    <li id="menu-item-29"
                                        ...
                                        <a title="History Result" href="https://kroasiaprize.com/history-result/"
                                            class="nav-link">History Result</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row no-gutters justify-content-between align-items-center">
                    <div class="col-12 col-lg">
                        <h3 class="text-white text-center text-lg-left mb-0">
                            <span><b>Today Lottery Result</b></span>
                        </h3>
                        <p class="text-white text-center text-lg-left mb-0">
                            <span>Check your lotto results online, find all the lotto winning numbers and see if you won the
                                latest lotto jackpots!</span>
                        </p>
                    </div>
                    <div class="col-12 col-lg-auto">
        ...
        <section>
            <div class="bg-color-3">
                <div class="container px-3 py-4 py-lg-5">
                    <p class="text-8 text-center mb-1">
                        <span>Result date <i class="fa fa-calendar"></i> <b><script>document.write(formatDateS(ResultDate));</script></b></span>
                    </p>
                    <div class="row no-gutters justify-content-center align-items-center">
                        <div class="col-12 col-lg-auto">
                            <div class="jackpot-date text-2 text-center mr-lg-2">
                                <span>Today Winner</span>
                    ...
                    <h5 class="text-8 text-center line-height-1 mb-4">
                        <i>
                            <small>DON'T WASTE YOUR TIME!</small>
                            <small>WIN TODAY!</small>
                        </i>
                    </h5>
                    <p class="text-7 text-center mb-3 mb-lg-0">
                        <span><b>Live Draw hours&nbsp;:&nbsp;</b></span>
                        <span class="badge badge-sm badge-dark px-2 py-2">05:45 AM</span>
                        <span>&nbsp;-&nbsp;</span>
                        <span class="badge badge-sm badge-dark px-2 py-2">06:00 AM</span>
                    </p>
                </div>
                ...
                <div class="row no-gutters align-items-center">
                        ...
                        <div class="row no-gutters justify-content-center align-items-center">
                            <div class="col-auto">
                                <div class="result-title">
                                    <h5 class="text-9 text-center mb-0">2nd</h5>
                                </div>
                            </div>
                            <div class="col-auto">
                                <h6 class="text-2 text-center text-uppercase my-0">
                        ...
                        <div class="result-container my-3">
                            <div class="row no-gutters justify-content-center">
                                <div class="col-auto prize">
                                    ...
                                    >
                                        <div class="prize-block d-inline-block mini ball-8">
                                            <div class="prize-digit"> 
                    ...
                    <div class="col-12 col-lg-3 px-1">
                        <div class="row no-gutters justify-content-center align-items-center">
                            <div class="col-auto">
                                <div class="result-title">
                                    <h5 class="text-9 text-center mb-0">3rd</h5>
                                </div>
                            </div>
                            <div class="col-auto">
                                <h6 class="text-2 text-center text-uppercase my-0">
                                    <span>Third Winner</span>
                                </h6>
                            </div>
                        </div>
                        <div class="result-container my-3">
                    ...
                    <div class="col-12 col-lg-3 px-1">
                        <div class="row no-gutters justify-content-center align-items-center">
                            <div class="col-auto">
                                <div class="result-title">
                                    <h5 class="text-9 text-center mb-0">SP</h5>
                                </div>
                            </div>
                            <div class="col-auto">
                                <h6 class="text-2 text-center text-uppercase my-0">
                    ...
                    <div class="col-12 col-lg-3 px-1">
                        <div class="row no-gutters justify-content-center align-items-center">
                            <div class="col-auto">
                                <div class="result-title">
                                    <h5 class="text-9 text-center mb-0">CP</h5>
                                </div>
                            </div>
                            <div class="col-auto">
                                <h6 class="text-2 text-center text-uppercase my-0">
                        ...
                        <div class="result-container my-3">
                            <div class="row no-gutters justify-content-center">
                                <div class="col-auto prize">
                                    <div id="lastdraw-lottery-consolation-1" class="text-center prize-wrapper">
                                        <div class="prize-block d-inline-block mini ball-2">
                                            <div class="prize-digit"> 
                                                <span><script>document.write(ConsoWinStr[0]);</script></span>
                                            </div>
                                        </div>
                                        <div class="prize-block d-inline-block mini ball-3">
                                            <div class="prize-digit">
                                                <span><script>document.write(ConsoWinStr[1]);</script></span>
                                            </div>
                                        </div>
                                        <div class="prize-block d-inline-block mini ball-7">
                                            <div class="prize-digit">
                                                <span><script>document.write(ConsoWinStr[2]);</script></span>
                                            </div>
                                        </div>
                                        <div class="prize-block d-inline-block mini ball-5">
                                            <div class="prize-digit">
        ...
        <div class="bg-color-9">
            <div class="col-12 col-lg">
                <div class="footer-wrapper px-3 py-4 ">
                    ...
                    <p class="text-5 mb-0">
                        <small>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <b>Kroasia Prize</b>, All rights reserved.</small>
                    </p>
                </div>
            </div>
        </div>
