...
<html lang="en-US">
    <head>
        ...
        <title>Live Draw Kroasia Prize - Official Lottery Website</title>
        <meta name="robots" content="max-image-preview:large">
        <link rel="stylesheet" id="wp-block-library-css" href="../assets/style.min.css" type="text/css" media="all">
        <meta name="generator" content="WordPress 6.4.2">
        <link rel="canonical" href="https://kroasiaprize.com/live-draw">
        <link rel="shortlink" href="https://kroasiaprize.com/live-draw">
            ...
            <div class="bg-color-3">
                <div class="container px-3 py-4 py-lg-5">
                    <p class="text-8 text-center mb-1">
                        <span>Result date <i class="fa fa-calendar"></i> <b><script>document.write(formatDate(ResultDate));</script></b></span>
                    </p>
